...
<div class="mb-2">
	{#if $intestines.thicknessDuo}
		<span>Dvylikapirštės žarnos sienelės storis yra {$intestines.thicknessDuo}cm<NormShow cat={TXT.DUO_CAT} dogSmall={TXT.DUO_DOG_SM} dogMedium={TXT.DUO_DOG_MD} dogLarge={TXT.DUO_DOG_LG}/>.</span>
	{/if}
	...
	{#if $intestines.thicknessCol}
		<span>Storosios žarnos sienelės storis yra {$intestines.thicknessCol}cm<NormShow dog={TXT.COL_DOG} cat={TXT.COL_CAT}/>.</span>
	{/if}
	...
	{/if}
		...
		<span>Stebimas 1 {$lymphnodes.sizeJejunal}s tuščiosios žarnos (mezenterinis) limfinis mazgas.</span>
	...
	{:else if $lymphnodes.numberJejunal}
		<span>Stebimi {$lymphnodes.numberJejunal} tuščiosios žarnos (mezenteriniai) limfiniai mazgai.</span>
	{/if}

	{#if $lymphnodes.echogenJejunal && $lymphnodes.numberJejunal > 1}
		<span>Tuščiosios žarnos (mezenterinių) lm. parenchima yra {$lymphnodes.echogenJejunal} juos supantiems riebalams.</span
		>
	{:else if $lymphnodes.echogenJejunal}
		<span
			>Tuščiosios žarnos (mezenterinio) lm. parenchima yra {$lymphnodes.echogenJejunal} ją supantiems riebalams.</span
		>
	{/if}
...
{#if $lymphnodes.echogenColic && $lymphnodes.numberColic > 1}
	<span>Gaubtinės žarnos lm. parenchima yra {$lymphnodes.echogenColic} juos supantiems riebalams.</span
	>
