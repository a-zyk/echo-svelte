...
export const HYPERADRENO_DESCR = `Šuo dėl hipofizės adenomos kylantis kušingas, prieinksčio hiperplazija.`

export const NEOPLASIA_TEXT = `Feochromocitoma, šuo.`
export const NEOPLASIA_DESCR = `Ultragarsinio tyrimo metu aptinkamų prieinksčių darinių vaizdas yra nepecifinis. Diferencinės diagnozės: žievės adenoma, adenocarcinoma, feochromocitoma, myelolipoma, metastazės, hiperplazija. Gerai lokalizuotos masės >2cm skersmens greičiau yra dariniai, nei hiperplazija, >4cm darinys greičiausiai piktybinis. Vis dėlto, tiek gerybiniai tiek piktybiniai dariniai gali būti dideli. Pagrindinis piktybiškumo rodiklis- invazija į aplinkinius audinius bei kraujagyslių embolizacija.`


export const WIDTH_CAT = " (n- 0.35-0.45cm)"

export const WIDTH_DOG = " (n- 0.6-0.8cm)"

export const LENGHT_CAT = " (n- 1-1.1cm)"

export const LENGHT_DOG = " (n- 1-5cm)"
