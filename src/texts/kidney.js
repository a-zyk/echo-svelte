export const HEALTHY_KIDNEY_TEXT = `
...
`;
export const HEALTHY_KIDNEY_DESCRIPTION = `Normalus katės inkstas.`

export const DIFFUSE_KIDNEY_DISEASE_TEXT = `
...
`;
export const DIFFUSE_KIDNEY_DISEASE_DESCRIPTION = `Šuns inkstas, etileno glikolio intoksikacija. Rodyklė žymi 'rim sign' būdingą prie šios patologijos.`

export const INFARCT_KIDNEY_TEXT = `Infarktai matomi, kaip hiperechoiški trikampiai, kurių smailus galas liečia inksto šerdį. Inkstų infarktai gali išsivystiti dėl bet kokios priežasties, kuri sukelia hiperkrešėjimo būseną (hypercoagulable state) pvz. HCM,inkstų infekcija, sepsis, anfilaksinis šokas ir tt. Inkstų infarktai dažnesni katėms su HCM. Jauna katė su inkstų infarktais labiau tikėtina, kad turi HCM, nei sena katė. Infarktai gali būti ir atsitiktinis radinys ypač senoms katėms`;
export const INFARCT_KIDNEY_DESCRIPTION = `Šuo, inkstas. Rodyklės žymi hiperechoiškus infarktus. p - prasiplėtusi geldelė.`

export const CYST_KIDNEY_TEXT = `Inkstinės cistos, genetiškai nulemtos persams ir su persais maišytoms katėms.Indikuoja inkstų
parametrų sekimą, dėl didesnės inkstų nepakankamumo rizikos.`;
export const CYST_KIDNEY_DESCRIPTION = `Policistinis insktas katė. Daugybinės mažos ir viena didelė cista.`

export const ABSCESS_KIDNEY_TEXT = `Stebima cista su hiperechoiškomis nuosėdomis. Gyvūnai dažnai karsčiuoja, prastai jaučiasi,
stebima leukocitozė.`
export const ABSCESS_KIDNEY_DESCRIPTION = `Abscesas šuns inkste.`

export const LYMPHOMA_KIDNEY_TEXT = `Dažniausiai pasitaikanti neoplazija kačių inkstuose.Dažnesnės patinams. Dažnai asocijuota su FIV/FeLV infekcijomis. 40% kačių su multicentrine limfoma turi ir inkstų limfomą.`
export const LYMPHOMA_KIDNEY_DESCRIPTION = `Katė, renalinė limfoma. Būdingas požymis hipoechoiška juosta aplink inkstą - "halo sign".`
...
export const CARCINOMA_KIDNEY_DESCRIPTION = `Šuo, renalinė karcinoma.`
 ...
 export const LENGTH_CAT = " (n~ 3-4.5cm)"

 export const LENGTH_WIDTH_CAT = " (n~ 3-4.5cm x 2.23-2.83cm)"
